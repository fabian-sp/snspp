...
params_snspp = {'max_iter' : 120, 'batch_size': 280, 'sample_style': 'constant', \
                'alpha' : 2.5, 'reduce_variance': True}
...
if _plot:
    ...
    if _save:
        fig.savefig('../data/plots/exp_mnist/error.pdf', dpi = 300)
    ...
    if _save:
        fig.savefig('../data/plots/exp_mnist/accuracy.pdf', dpi = 300)
    ...
    if _save:
        fig.savefig('../data/plots/exp_mnist/coeff.pdf', dpi = 300)
